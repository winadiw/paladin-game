...
public class Minion_Dragon : MonoBehaviour
{
    public AudioClip slashSound;
    //SoundManager.instance.PlaySingle(slashSound);
    private string enemyName = "Dragon";
	...
	public Rigidbody2D clawAttack;
	public Transform dragonFront;
	...
	public void EnemyAttack()
	{
        if (attackCooldown <= 0)
		{
            Instantiate(clawAttack, dragonFront.position, dragonFront.rotation);
			attackCooldown = 20f;
            SoundManager.instance.PlaySingle(slashSound);
        }
	}
